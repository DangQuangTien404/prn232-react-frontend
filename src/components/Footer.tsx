      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col items-center text-center md:flex-row md:justify-between md:text-left">
          <div className="mb-6 md:mb-0">
            <Link
              to="/"
              className="flex items-center justify-center gap-2 text-xl font-bold text-gray-800 md:justify-start"
            >
              <Plane className="text-blue-600" />
              <span>Mathslide</span>
            </Link>
            <p className="mt-2 text-sm text-gray-500">© 2024 Mathslide Learning. All Rights Reserved.</p>
